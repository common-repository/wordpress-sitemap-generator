...
class GoogleSitemapGenerator {
	...
	*/
	...
	function BuildSitemap() {
		...
		$this->AddElement(new GoogleSitemapGeneratorDebugEntry("sitemap-generator-url=\"http://www.escalateseo.com\" sitemap-generator-version=\"" . $this->GetVersion() . "\""));
	...
	function GetRedirectLink($redir) {
		return trailingslashit("http://www.escalateseo.com/redir/" . $redir);
	}
